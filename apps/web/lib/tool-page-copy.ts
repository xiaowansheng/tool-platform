...
const zhToolPageGuides: Record<string, ToolPageGuide> = {
  ...
  "brick-breaker": {
    ...
    steps: [
      ...
      "按空格键或点击屏幕将球向斜上方发射，球在碰撞砖块、墙壁 and 挡板时会自动弹起。",
  ...
  "digital-muyu": {
    ...
    intro: "赛博禅堂（Cyber Zen Temple）是一款结合传统静心仪式与现代化解压体验的娱乐修行工具。集成了自动木鱼打坐机、三柱虚拟清香、虔诚跪拜蒲团，带给您满满的赛博功德与平和心境。",
    steps: [
      "点击顶部导航在「木鱼功德机」、「三清福香炉」和「虔诚跪拜垫」三大法器间进行切换。",
      "在木鱼页面，点击木鱼或按空格敲击，可开启「自动木鱼机」进行机械手臂/机甲齿轮自动敲击挂机，同时可定制「功德+1」、「烦恼-1」等悬浮词条。",
      "在香炉页面，点击「上一柱清香」插香，支持设置心愿卡并可实时看到香条燃烧缩短与缕缕云烟袅袅升起的效果。",
      "在蒲团页面，点击金莲花蒲团进行叩首，伴随着深沉的铜磬合鸣，屏幕会浮现祈福人虔诚磕头叩拜的身影，记录叩拜次数。"
    ],
    examples: ["敲木鱼累了，给服务器插三柱清香祈求上线无 Bug。", "双开挂机自动敲木鱼，配合背景木磬铜钟声，打造极简静谧的办公环境。", "点击跪拜垫，为家人朋友在线虔诚磕头祈福。"]
  },
  "stress-relief-box": {
    name: "压力宣泄神盒",
    description: "赛博打工人专属解压疗愈工具箱。包含烦恼粉碎机、老板模拟器、讽刺点赞器、无效呐喊筒、后悔药模拟器、以及赛博功德箱，帮您一键排解焦虑与压力。",
    intro: "压力宣泄神盒收集了多种幽默、解压和疗愈的赛博情绪玩具。无论你是在被无理需求折磨、想对虚无咆哮、还是渴望用后悔药回滚人生，这里都有一款工具能让你会心一笑，释放工作压力。",
    steps: [
      "在顶部切换菜单，选择你想体验的宣泄玩具。",
      "在「烦恼粉碎机」中输入怨言或Bug，点击拉动碎纸阀门，亲眼看着文本被碎成碎条粉末掉落。",
      "在「老板模拟器」里体验经典的 corporate 话术或发起反击，在「讽刺点赞器」中领略阴阳怪气的高级职场赞美。",
      "在「无效呐喊筒」对着黑洞咆哮，在「后悔药模拟器」一键回滚你的人生遗憾，或在「赛博功德箱」投币祈福。"
    ],
    examples: ["把“明天还要周报”输入粉碎机亲眼看着它被撕碎成渣。", "心情郁闷时狂点点赞器，收获一整屏阴阳怪气但令人捧腹的代码称赞。", "投掷几枚赛博硬币到功功德箱中，发出清脆的撞击声并收获“工资翻倍”功德。"]
  },
  "retro-arcade": {
    name: "赛博街机模拟器",
    description: "一款高保真、沉浸式的赛博霓虹街机中心，聚合 Flappy Bird、接金币、打地鼠、射击小游戏、华容道、九宫拼图、泡泡龙、宝石消消乐和祖玛等九款经典复古街机与益智小游戏，配备复古合成器音效和粒子动画。",
    intro: "赛博街机模拟器（Retro Arcade Platform）是一个炫酷的多合一游戏大厅，重现了八九十年代的复古电子游戏氛围。不仅拥有 Flappy Bird（飞越霓虹）、接金币（金币雨）、打地鼠（地鼠危机）、射击小游戏（星际防线）、华容道（古道突围）、拼图（九宫魔方）、泡泡龙（泡泡大作战）、宝石迷阵（宝石消消乐）和祖玛（祖玛神像）这九大经典游戏，还融入了赛博朋克霓虹光效、粒子系统与复古合成器音效，帮您彻底释放压力、重拾童年乐趣。",
    steps: [
      "在街机大厅的主菜单中，选择你想要游玩的游戏，或者直接使用游戏列表进行快速启动。",
      "阅读各款游戏特有的控制说明（如空格/点击控制 Flappy Bird 飞行、方向键控制滑块移动或发射球泡泡等）。",
      "开始挑战！击败外星飞船、消除珠子、接住掉落的黄金，争夺个人高分榜首。",
      "遇到难关时可随时重置或切换到其他更轻松的游戏，享受放松而愉快的解压时光。"
    ],
    examples: ["在「飞越霓虹」中挑战无尽的高空管道缝隙障碍。", "在「星际防线」中享受激光轰鸣、击落成群入侵战机的爽快打击感。", "利用「宝石消消乐」或「祖玛神像」的连消特效解压疗愈。"]
  },
...
const zhToolNameOverrides: Record<string, string> = {
  ...
  "brick-breaker": "霓虹打砖块",
  "digital-muyu": "赛博禅堂",
  "stress-relief-box": "压力宣泄神盒",
  "retro-arcade": "赛博街机模拟器",
